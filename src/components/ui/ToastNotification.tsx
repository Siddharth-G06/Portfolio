      ...
      <AnimatePresence>
        {messages.map((msg) => (
          <motion.div
            ...
            className="bg-[#1E1610] border border-[#352515] text-[#F0E8D8] px-4 py-3 shadow-[0_10px_30px_-10px_rgba(0,0,0,0.5)] flex items-center gap-3 font-sans max-w-sm pointer-events-auto"
          >
